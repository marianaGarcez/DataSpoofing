...
def get_cluster_insights(df_original, n_neighbors, mmsi):
    """
    this function detects the clusters and returns whether the trajectory has 
    location spoofing or identity spoofing or both or none
...
def compare_cluster_density_return_outlier_index(cluster1, cluster2, index, df_groups):
    # returns the cluster that has the lowest density
